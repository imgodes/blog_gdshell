  ...
  steps={[
    {
      ...
      description: "O usuário acessa vps01.exemplo.com e é direcionado para rede anycast da Cloudflare"
    },
    {
      title: "Rede Anycast e Proxy Reverso",
      description: "A Cloudflare intercepta a requisição de verifica as regras implementadas"
    },
    {
      title: "Zero Trust Access",
      description: "A Cloudflare direciona o usuário para o processo de autenticação implementado (Google, GitHub, SSO, etc)"
    },
    {
      title: "Acesso final",
      description: "Apenas após a validação bem sucedida, o usuário é direcionado para a aplicação final"
    }
  ]}
/>
