...
Mais detalhes sobre essa diferença estão na página sobre a Máquina Virtual Dalvik.
...
Falaremos mais sobre cada um desses componentes na seção sobre Componentes e IPC.
