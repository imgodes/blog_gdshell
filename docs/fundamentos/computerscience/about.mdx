...
<Stepper>
  ...
  <Step title="Organização e conexão">
    Aqui foi onde eu passei grande parte do meu tempo. Saber qual tema deve vir antes de outro e como eles se conectam foi uma das minhas prioridades. Não quis apenas descrever um conceito e passar para o próximo e sim criar uma linha de raciocínio em que eles se relacionam.
  </Step>
</Stepper>
...
Se você possui familiaridade com matemática e interesse por computadores, celulares ou videogames saiba que não é necessário mais do que isso para acompanhar o conteúdo apresentado. Para aqueles que ainda não se sentem confortáveis com o tema: dê uma chance.
