...
- **[Introdução](02-intro.md)** - afinal, o que são os computadores para os seres humanos? O que é computar? Neste capítulo eu busco introduzir o termo "computação" mais do ponto de vista filosófico do que técnico. Também desmistifico alguns conceitos iniciais sobre a computação.
- **[Computadores](03-computadores.mdx)** - agora com um viés técnico, explico sobre o computador enquanto máquina, tecnologia e ferramenta do qual se usa esperando que cumpra algum propósito prático.
- **[Números](04-numeros.md)** - se com o capítulo anterior foi entendido que computadores nada mais fazem do que realizar tarefas com números, é necessário então ter um bom entendimento do que é um número!
- **[Sistemas de Numeração](05-sistemas_de_numeracao.md)** - Notação posicional, sistema binário, conversão entre bases e convenções de notação.
- **[Bits e Bytes](06-bits.md)** - A menor unidade de informação, como combinar bits para representar mais valores, bytes e prefixos de grandeza.
- **[Hexadecimal](07-hexadecimais.md)** - O sistema de base 16, sua relação direta com o binário e por que ele é tão presente na programação.
# Referencias
